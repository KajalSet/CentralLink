package com.CentralLink.admin.config;
...
import com.CentralLink.admin.filters.JwtRequestFilter;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests()
				.antMatchers("/api/auth/authenticate", "/api/auth/posauthenticate", "/api/auth/signup",
						...
						"/api/auth/verifyemail", "/api/panVerification/verify-pan-and-get-details/**","/api/blogs", "/api/Inquiry", "/api/services/**","/api/settings/**","/api/project","/api/blogs/**",
