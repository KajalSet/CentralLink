...
public interface UserRepo extends JpaRepository<User, UUID>, JpaSpecificationExecutor<User> {
	 ...
	 * ) Page<User> getAllUser(@Param("str") String str, @Param("active") boolean
	...
	Page<User> getAllUser(@Param("str") String str, @Param("active") boolean active, @Param("role") String role,
			Pageable pageable);
