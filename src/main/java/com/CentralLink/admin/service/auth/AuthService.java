...
import com.CentralLink.admin.model.auth.SignupRequest;
import com.CentralLink.admin.model.auth.User;
import com.CentralLink.admin.model.master.Company;
import com.CentralLink.admin.pojo.request.LoginRequest;
import com.CentralLink.admin.pojo.response.SignupResponse;
import com.CentralLink.admin.repositories.auth.ProfileRepo;
import com.CentralLink.admin.repositories.auth.RoleRepo;
...
//	@Autowired
//	private DistributorUserRepo distributorUserRepo;
...
//
//			Company newCreated = companyRepo.save(company);
//
//			User user = createUser(signupRequest, newCreated);
//
//			String token = UUID.randomUUID().toString();
//			createVerificationTokenForUser(user, token);
//
...
//		} 
	...
	public User createUser(SignupRequest signupRequest, Company company) {
		User user = new User();
		...
		// user.setCompany(signupRequest.getCompanyName())
